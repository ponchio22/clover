...
namespace PipeServer
{
    ...
    class Server
    {
        ...
        public void Start()
        {
            ...
            this.listenThread.Name = "Server Listen Thread for " + this.pipeName;
        ...
        public void Stop()
        {
            try
            {
                if (this.readThread != null) this.readThread.Abort();                
            }
            catch(Exception ex)
            {
            ...
            try
            {
                if (this.listenThread != null) this.listenThread.Abort();
            }
            catch (Exception ex)
            {
                Console.WriteLine("Exception: " + ex.ToString());
            ...
            while (true)
            {
                ...
                if (!clientHandle.IsInvalid)
                {
                    ...
                    if (success != 0)
                    {
                        ...
                        readThread.Name = "Server thread for " + this.pipeName;
